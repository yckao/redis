...
type redisVersion interface {
	ClusterCreateCmd(isTLS bool, replicas int32, addrs ...string) []string
	AddNodeAsMasterCmd(isTLS bool, newAddr, existingAddr string) []string
	AddNodeAsSlaveCmd(isTLS bool, newAddr, existingAddr, masterId string) []string
	DeleteNodeCmd(isTLS bool, existingAddr, deletingNodeID string) []string
	ReshardCmd(isTLS bool, srcIP, srcID, dstIP, dstID string, slotStart, slotEnd int) []string
}
...
func (v version4) ClusterCreateCmd(isTLS bool, replicas int32, addrs ...string) []string {
...
func (v version4) AddNodeAsMasterCmd(isTLS bool, newAddr, existingAddr string) []string {
	return []string{"redis-trib", "add-node", newAddr, existingAddr}
}

func (v version4) AddNodeAsSlaveCmd(isTLS bool, newAddr, existingAddr, masterId string) []string {
	return []string{"redis-trib", "add-node", "--slave", "--master-id", masterId, newAddr, existingAddr}
}

func (v version4) DeleteNodeCmd(isTLS bool, existingAddr, deletingNodeID string) []string {
	return []string{"redis-trib", "del-node", existingAddr, deletingNodeID}
}

func (v version4) ReshardCmd(isTLS bool, srcIP, srcID, dstIP, dstID string, slotStart, slotEnd int) []string {
...
func (v version5) ClusterCreateCmd(isTLS bool, replicas int32, addrs ...string) []string {
...
func (v version5) AddNodeAsMasterCmd(isTLS bool, newAddr, existingAddr string) []string {
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
	}
...
func (v version5) AddNodeAsSlaveCmd(isTLS bool, newAddr, existingAddr, masterId string) []string {
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
	}
...
func (v version5) DeleteNodeCmd(isTLS bool, existingAddr, deletingNodeID string) []string {
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
	}
...
func (v version5) ReshardCmd(isTLS bool, srcIP, srcID, dstIP, dstID string, slotStart, slotEnd int) []string {
	existingAddr := fmt.Sprintf("%s:%d", srcIP, api.RedisNodePort)
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
...
*******************************************/
// https://redis.io/commands/cluster-nodes
func ClusterNodesCmd(isTLS bool, ip string) []string {
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
	}
...
// https://redis.io/commands/cluster-meet
func ClusterMeetCmd(isTLS bool, senderIP, receiverIP, receiverPort string) []string {
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
	}
...
// https://redis.io/commands/cluster-reset
func ClusterResetCmd(isTLS bool, ip, resetType string) []string {
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
	}
...
// https://redis.io/commands/cluster-failover
func ClusterFailoverCmd(isTLS bool, ip string) []string {
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
	}
...
// https://redis.io/commands/cluster-replicate
func ClusterReplicateCmd(isTLS bool, ip, masterNodeID string) []string {
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
	}
...
// https://redis.io/commands/ping
func PingCmd(isTLS bool, ip string) []string {
	command := []string{"redis-cli"}
	if isTLS == true {
		command = append(command, tlsArgs...)
	}
