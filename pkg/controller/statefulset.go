				...
				Sources: []core.VolumeProjection{
					{
						Secret: &core.SecretProjection{
							LocalObjectReference: core.LocalObjectReference{
								Name: meta_util.NameWithSuffix(redis.Name, api.RedisServerSecretSuffix),
							},
					...
					},
					{
						Secret: &core.SecretProjection{
							LocalObjectReference: core.LocalObjectReference{
								Name: meta_util.NameWithSuffix(redis.Name, api.RedisExternalClientSecretSuffix),
							},
							Items: []core.KeyToPath{
								{
									Key:  "tls.crt",
				...
				Sources: []core.VolumeProjection{
					{
						Secret: &core.SecretProjection{
							LocalObjectReference: core.LocalObjectReference{
								Name: meta_util.NameWithSuffix(redis.Name, api.RedisExporterClientSecretSuffix),
							},
							Items: []core.KeyToPath{
								{
									Key:  "ca.crt",
